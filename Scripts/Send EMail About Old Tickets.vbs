...
Do Until objTechList.EOF
   ...
   strSQL = strSQL & "Where Tech='" & objTechList(0) & "' AND SubmitDate<Date()-""14"" AND Status<>'Complete'"
...
Sub SendEMail
   ...
   strMessage = strMessage & "Below you will find a list of help desk tickets that are older then 2 weeks.  " & vbCRLF & vbCRLF
